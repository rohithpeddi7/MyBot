...
__all__ = [
    'SVESentenceBoundary', 'SVSFIsFilename', 'DISPID_SGRInitialState',
    'SP_VISEME_7', 'DISPID_SRProfile', 'DISPID_SAFGuid',
    'DISPID_SpeechPhraseAlternates', 'SVPNormal', 'DISPID_SGRsItem',
    'SFTSREngine', 'SVP_21', 'SpeechTokenKeyUI',
    'DISPID_SRGIsPronounceable', 'SGRSTTWildcard', 'DISPID_SPPId',
    'SpeechFormatType', 'SpMMAudioIn', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SDKGetBinaryValue', 'ISpeechRecognizer',
    'SpeechCategoryPhoneConverters', 'DISPID_SAFType', 'SPWT_DISPLAY',
    'SpeechAudioVolume', 'SPAUDIOBUFFERINFO', 'SAFT24kHz8BitMono',
    'SDA_One_Trailing_Space', 'SPPS_Function', 'ISpMMSysAudio',
    'ISpRecoContext', 'SECHighConfidence',
    'SWPKnownWordPronounceable', 'SPGS_EXCLUSIVE', 'SPVPRI_OVER',
    'DISPID_SRRTStreamTime', 'DISPID_SRCEAdaptation',
    'DISPIDSPTSI_SelectionOffset', 'ISpeechVoice', 'SPPHRASE',
    'ISpRecoContext2', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SGRsCount', 'SpeechVoiceSpeakFlags',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SSTTWildcard', 'DISPID_SBSSeek',
    'ISpProperties', 'DISPID_SVSLastBookmarkId', 'SpeechDiscardType',
    'DISPID_SVGetAudioOutputs', 'SpeechAudioFormatGUIDWave',
    'SP_VISEME_2', '_SPAUDIOSTATE', 'SpeechAllElements',
    'DISPID_SPEEngineConfidence', 'DISPIDSPTSI_SelectionLength',
    'SPPS_NotOverriden', 'SpeechStreamFileMode', 'SSFMOpenForRead',
    'SVP_8', 'DISPID_SVSInputWordPosition', 'SPPHRASEREPLACEMENT',
    'STCInprocHandler', 'DISPID_SPIAudioSizeBytes',
    'SPAO_RETAIN_AUDIO', 'IEnumSpObjectTokens',
    'DISPID_SRCreateRecoContext', 'DISPID_SpeechFileStream',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPEAudioTimeOffset',
    'eLEXTYPE_PRIVATE9', 'DISPID_SABIBufferSize', 'ISpeechMMSysAudio',
    'SpeechDataKeyLocation', 'DISPID_SWFESamplesPerSec',
    'SPEI_END_INPUT_STREAM', 'DISPID_SPCPhoneToId', 'ISpRecoResult',
    'ISpPhrase', 'SPXRO_Alternates_SML', 'SpeechAudioFormatType',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVSpeakCompleteEvent',
    'SRCS_Disabled', 'SPEI_UNDEFINED', 'DISPID_SLPPartOfSpeech',
    'DISPID_SLPsItem', 'SDTProperty', 'DISPID_SOTs_NewEnum',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SASetState', 'SPRULE',
    'DISPID_SRSetPropertyString', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechGrammarRules', 'SPRST_NUM_STATES',
    'ISpeechFileStream', 'SGDSActive', 'DISPID_SRRGetXMLResult',
    'SAFTADPCM_11kHzStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPINTERFERENCE', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SVEVoiceChange', 'SP_VISEME_11', 'SPSInterjection',
    'DISPID_SRCEHypothesis', 'SRAImport', 'DISPID_SVSPhonemeId',
    'SpeechCategoryAppLexicons', 'SPSHT_EMAIL', 'SPGS_ENABLED',
    'DISPID_SVEAudioLevel', 'DISPID_SPPs_NewEnum', 'SPWT_LEXICAL',
    'SRTExtendableParse', 'SpeechPropertyResourceUsage',
    'SpPhraseInfoBuilder', 'SPLO_DYNAMIC', 'DISPID_SPAPhraseInfo',
    'DISPID_SOTCEnumerateTokens', 'SPVPRI_NORMAL',
    'SREPropertyNumChange', 'DISPID_SGRs_NewEnum',
    'SpeechInterference', 'SFTInput', 'STSF_AppData', 'SINone',
    'SP_VISEME_14', 'DISPID_SPRsItem', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRCPause', 'DISPID_SBSWrite', 'DISPID_SGRsCommit',
    'SVEStartInputStream', 'SRTStandard',
    'DISPID_SRRDiscardResultInfo', 'SVPAlert', 'SPSHORTCUTTYPE',
    'SAFT22kHz16BitStereo', 'DISPID_SRRRecoContext', 'SpWaveFormatEx',
    'DISPID_SWFEBitsPerSample', 'DISPID_SLWsCount',
    'DISPID_SRRSpeakAudio', 'ISpeechRecoResult', 'SPEI_TTS_PRIVATE',
    'DISPID_SLWType', 'eLEXTYPE_PRIVATE2', 'SPCONTEXTSTATE',
    'eLEXTYPE_PRIVATE3', 'SPEI_MIN_SR', 'SRADefaultToActive',
    'SBONone', 'DISPID_SOTCSetId', 'SPAS_RUN',
    'SpeechTokenValueCLSID', 'SPEI_END_SR_STREAM',
    'DISPID_SpeechMMSysAudio', 'SPSNotOverriden', 'SPRST_INACTIVE',
    'SpeechEngineProperties', 'DISPID_SDKOpenKey', 'DISPID_SAStatus',
    'SP_VISEME_1', 'DISPID_SRCERecognition', 'DISPID_SRCRecognizer',
    'SpeechGrammarTagWildcard', 'SPSEMANTICFORMAT',
    'SAFT8kHz16BitStereo', 'SPAR_Medium', 'ISpRecoCategory',
    'DISPID_SOTId', 'DISPID_SRGCmdSetRuleIdState', 'SRTAutopause',
    'SpObjectToken', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPPS_RESERVED4', 'DISPID_SLRemovePronunciation', 'SVEPhoneme',
    'SpeechGrammarWordType', 'SP_VISEME_9',
    'DISPID_SpeechCustomStream', 'DISPID_SVEStreamStart',
    'SREAudioLevel', 'SPEI_SOUND_END', 'SPAR_Low', 'SpMMAudioEnum',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechWordPronounceable',
    'DISPID_SASNonBlockingIO', 'SDKLDefaultLocation',
    'ISpeechPhraseAlternates', 'DISPID_SPPName', 'SGSDisabled',
    'SREFalseRecognition', 'eLEXTYPE_RESERVED8', 'SSSPTRelativeToEnd',
    'eLEXTYPE_USER_SHORTCUT', 'SVEAudioLevel', 'SINoSignal',
    'SP_VISEME_16', 'eLEXTYPE_PRIVATE19', 'SSFMCreate',
    'DISPID_SPPConfidence',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRSetPropertyNumber', 'SVP_6', 'SP_VISEME_17',
    'DISPID_SPPParent', 'UINT_PTR', 'DISPID_SVEEnginePrivate',
    'SRAExport', 'SVP_1', 'DISPID_SPIGetDisplayAttributes',
    'STSF_LocalAppData', 'DISPID_SLWPronunciations',
    'DISPID_SPRulesItem', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SOTCategory',
    'SpMMAudioOut', 'eLEXTYPE_MORPHOLOGY', 'SSTTDictation',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SGRSTsCount',
    'SpeechDisplayAttributes', 'SpeechAudioFormatGUIDText',
    'SAFT16kHz16BitStereo', 'SPCT_COMMAND',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SMSGetData',
    'DISPID_SPEsItem', 'SPBO_NONE', 'DISPID_SRSCurrentStreamNumber',
    'SpeechGrammarState', 'ISpPhoneticAlphabetConverter',
    'eLEXTYPE_RESERVED4', 'SVP_11', 'DISPID_SpeechPhraseProperties',
    'SSSPTRelativeToCurrentPosition', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechObjectToken', 'SPEI_ADAPTATION', 'SVP_15',
    '__MIDL_IWinTypes_0009', 'SPVISEMES', 'DISPID_SRDisplayUI',
    'ISpeechGrammarRule', 'ISpeechAudioFormat', 'SP_VISEME_6',
    'SVP_2', 'SAFT8kHz8BitMono', 'DISPID_SVIsUISupported',
    'SRSActive', 'SPRST_ACTIVE', 'SpObjectTokenCategory',
    'SAFT11kHz8BitStereo', 'LONG_PTR', 'ISpeechLexiconWords',
    'eLEXTYPE_PRIVATE18', 'SAFT22kHz16BitMono', 'SPSFunction',
    'DISPID_SGRSRule', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SDKDeleteKey', 'SpPhoneticAlphabetConverter',
    'SP_VISEME_0', 'DISPID_SOTCGetDataKey', 'SVP_10',
    'SpeechTokenContext', 'DISPID_SVESentenceBoundary',
    'SPFM_CREATE_ALWAYS', 'SAFT24kHz8BitStereo', 'SP_VISEME_18',
    'SSTTTextBuffer', 'SVSFNLPMask', 'SDTAll',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRRAlternates',
    'DISPID_SPIElements', 'SRAORetainAudio', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SDKSetLongValue', 'SAFT12kHz16BitStereo',
    'SAFT44kHz16BitStereo', 'SAFT12kHz16BitMono',
    'SAFTADPCM_8kHzStereo', 'SPEI_HYPOTHESIS', 'ISpeechPhraseElement',
    'DISPID_SpeechLexiconWords', 'eWORDTYPE_DELETED', 'SPAS_PAUSE',
    'DISPID_SRGState', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SDKSetBinaryValue', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRGetPropertyNumber', 'SPPHRASEPROPERTY',
    'SAFT48kHz8BitStereo', 'SRESoundStart',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechLexicon',
    'eLEXTYPE_PRIVATE10', 'SVSFPurgeBeforeSpeak', 'SVP_14',
    'DISPID_SpeechPhoneConverter', 'SRADynamic',
    'DISPID_SPIReplacements', 'SECFIgnoreWidth', 'SVP_0',
    'DISPID_SGRSTPropertyId', 'SECFIgnoreCase', 'DISPID_SLWLangId',
    'DISPID_SVGetProfiles', 'DISPID_SBSRead', 'SECNormalConfidence',
    'DISPID_SVGetAudioInputs', 'SPFM_CREATE', 'SPWORDPRONOUNCEABLE',
    'SpeechMicTraining', 'ISpeechPhraseReplacements',
    'ISpRecognizer2', 'DISPID_SPRsCount', 'SpeechRunState',
    'eLEXTYPE_PRIVATE12', 'SAFTNonStandardFormat',
    'DISPID_SOTIsUISupported', 'eWORDTYPE_ADDED',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSInputWordLength', 'SP_VISEME_13', 'SPGS_DISABLED',
    'ISpSerializeState', 'eLEXTYPE_PRIVATE1', 'SPEI_TTS_BOOKMARK',
    'DISPID_SVEPhoneme', 'DISPID_SRCEStartStream', 'ISpLexicon',
    'DISPID_SASState', 'SPPS_Unknown', 'SPEI_PHONEME',
    'eLEXTYPE_RESERVED9', 'ISpeechDataKey',
    'DISPID_SPANumberOfElementsInResult', 'SPEI_START_INPUT_STREAM',
    'ISpeechPhraseRules', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SPRuleEngineConfidence', 'ISpeechAudioBufferInfo',
    'SpeechPropertyAdaptationOn', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechPhraseElements', 'SPVOICESTATUS', 'SAFT32kHz16BitMono',
    'SPPS_Modifier', 'SVSFDefault', 'ISpVoice', 'DISPID_SOTCDefault',
    'SPCS_ENABLED', 'ISpeechTextSelectionInformation',
    'DISPID_SVEBookmark', 'DISPID_SPRuleNumberOfElements',
    'SECFIgnoreKanaType', 'DISPID_SGRClear', 'DISPID_SRCEBookmark',
    'SWPUnknownWordPronounceable', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechGrammarRuleStateTransitions', 'eLEXTYPE_PRIVATE14',
    'SAFT32kHz8BitMono', 'SPWORDTYPE', 'SAFT32kHz8BitStereo',
    'DISPID_SVSVisemeId', 'SREPhraseStart', 'DISPID_SRRTTickCount',
    'SAFT16kHz16BitMono', 'SAFTCCITT_ALaw_44kHzMono',
    'SPEI_RECOGNITION', 'DISPID_SPCLangId',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRCEAudioLevel', 'SPWF_SRENGINE',
    'DISPID_SDKSetStringValue', 'DISPID_SDKCreateKey',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpStreamFormatConverter',
    'ISpeechObjectTokens', 'DISPID_SPRules_NewEnum', 'SVSFIsNotXML',
    'Speech_Max_Word_Length', 'ISpRecoGrammar2', 'DISPID_SRStatus',
    'SPEI_REQUEST_UI', 'DISPID_SVVoice', 'DISPID_SGRId',
    'DISPID_SDKEnumValues', 'SPWORD', 'SAFT22kHz8BitStereo',
    'STSF_FlagCreate', 'DISPID_SPEAudioSizeBytes', 'DISPID_SVEViseme',
    'DISPID_SVAudioOutputStream', 'SRCS_Enabled', 'SPCT_SLEEP',
    'SRARoot', 'SP_VISEME_8', 'DISPID_SOTGetAttribute',
    'SPINTERFERENCE_LATENCY_WARNING', 'SGRSTTDictation',
    'Speech_StreamPos_RealTime', 'SBOPause', 'ISpDataKey',
    'DISPID_SPRFirstElement', 'ISequentialStream', 'SPAR_High',
    'SpeechLexiconType', 'DISPID_SRCRetainedAudio', 'ISpEventSource',
    '_ISpeechRecoContextEvents', 'DISPID_SRAudioInputStream',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SGRSTPropertyValue', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPIEngineId', 'DISPID_SpeechPhraseReplacement',
    'SREStreamEnd', 'ISpeechObjectTokenCategory', 'SRSActiveAlways',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SABufferInfo', 'SDKLCurrentUser', 'SVEPrivate',
    'SDTLexicalForm', 'eLEXTYPE_RESERVED7', 'DISPID_SRRTLength',
    'SpeechTokenKeyFiles', 'DISPID_SRCVoice', 'SPCT_SUB_COMMAND',
    'SPEI_RESERVED1', 'SDA_No_Trailing_Space', 'SVP_5', 'SRATopLevel',
    'DISPID_SRCEEndStream', 'SAFTADPCM_22kHzStereo',
    'SpeechVoiceEvents', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPPsCount', 'DISPID_SPRuleId', 'SpeechCategoryVoices',
    'DISPID_SPISaveToMemory', 'DISPID_SPACommit',
    'SpStreamFormatConverter', 'SPPS_LMA',
    'ISpeechLexiconPronunciation', 'DISPID_SVAlertBoundary',
    'SPPS_RESERVED2', 'SAFT8kHz8BitStereo', 'DISPID_SGRAddResource',
    'DISPID_SRRSaveToMemory', 'DISPID_SADefaultFormat',
    'SPINTERFERENCE_NOSIGNAL', 'ISpRecoGrammar', 'DISPID_SVStatus',
    'DISPID_SOTSetId', 'DISPID_SASCurrentDevicePosition',
    'SPPS_RESERVED3', 'SpUnCompressedLexicon', 'SPPHRASERULE',
    'SPGRAMMARWORDTYPE', 'DISPID_SFSClose', 'ISpeechRecoResult2',
    'DISPID_SWFEFormatTag', 'SREStateChange', 'SAFTGSM610_44kHzMono',
    'ISpeechRecoContext', 'SpeechTokenKeyAttributes',
    'DISPID_SPEDisplayText', 'DISPID_SVSLastResult',
    'SPPS_Interjection', 'DISPID_SVSpeakStream', 'DISPID_SFSOpen',
    'SSSPTRelativeToStart', 'SITooFast', 'DISPID_SPRText',
    'SPGRAMMARSTATE', 'SP_VISEME_3', 'SPEI_MAX_SR',
    'SPWT_PRONUNCIATION', 'DISPID_SVSRunningState', 'SPLO_STATIC',
    'DISPID_SPRulesCount', 'DISPID_SGRName', 'DISPID_SGRSTs_NewEnum',
    'ISpRecognizer', 'DISPID_SRGCmdSetRuleState', 'DISPID_SVSpeak',
    'ISpeechRecoResultDispatch', 'tagSTATSTG', 'SAFT44kHz16BitMono',
    'DISPID_SLPLangId', 'SREBookmark', 'SPSHORTCUTPAIRLIST',
    'SVF_Emphasis', 'DISPID_SpeechPhraseInfo', 'SPDKL_CurrentConfig',
    'SPEI_RESERVED5', 'DISPID_SRGDictationSetState', 'SVSFParseMask',
    'SAFT48kHz16BitStereo', 'SINoise', 'SpeechCategoryAudioIn',
    'SSFMCreateForWrite', 'SP_VISEME_12', 'SPAO_NONE',
    'SpeechPropertyNormalConfidenceThreshold', 'ISpStream',
    'DISPID_SVWaitUntilDone', 'SPSHT_OTHER', 'SAFTDefault',
    'SPFILEMODE', 'ISpStreamFormat', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SPEAudioStreamOffset', 'SVP_20', 'SPEI_VISEME',
    'DISPID_SVGetVoices', 'DISPID_SRRPhraseInfo',
    'DISPID_SAEventHandle', 'SVSFParseSapi', 'SDTPronunciation',
    'DISPID_SGRSTWeight', 'SPSMF_UPS', 'SWTDeleted',
    'DISPID_SGRsDynamic', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SLAddPronunciation', 'ISpeechResourceLoader', 'SPAS_STOP',
    'DISPID_SRCEInterference', 'SpeechSpecialTransitionType',
    'DISPID_SRGCmdLoadFromFile', 'SRTSMLTimeout',
    'SpeechRetainedAudioOptions', 'SpeechGrammarTagDictation',
    'SPSERIALIZEDPHRASE', 'SRERecoOtherContext',
    'SPEI_SR_RETAINEDAUDIO', 'SPEI_RESERVED3',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_PRIVATE13',
    'ISpeechPhoneConverter', 'DISPID_SVRate', 'DISPID_SPAsCount',
    'SpResourceManager', 'SAFT44kHz8BitMono', 'SPEI_SR_PRIVATE',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPRuleName',
    'DISPID_SLGetPronunciations', 'SPWORDPRONUNCIATION',
    'SVEWordBoundary', 'ISpeechPhraseInfo', 'DISPID_SLPSymbolic',
    'SpeechRuleAttributes', 'SpeechVoicePriority', 'SVSFVoiceMask',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SABIMinNotification',
    'DISPID_SPELexicalForm', 'DISPID_SPRuleConfidence',
    'DISPID_SRGetPropertyString', 'SPRECORESULTTIMES',
    'SPDKL_DefaultLocation', 'DISPID_SpeechLexiconProns',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_PRIVATE4',
    'DISPID_SWFEExtraData', 'SpeechAudioProperties',
    'SPINTERFERENCE_NONE', 'SPDATAKEYLOCATION',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCResume',
    'DISPID_SLWs_NewEnum', 'DISPID_SPAStartElementInResult',
    'SP_VISEME_20', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SpeechRecoResult2', 'Speech_StreamPos_Asap',
    'DISPID_SpeechObjectTokens', 'SRSEIsSpeaking',
    'DISPID_SGRSTPropertyName', 'DISPID_SRGetRecognizers',
    'DISPID_SpeechPhraseProperty', 'DISPID_SOTMatchesAttributes',
    'DISPID_SGRSAddWordTransition', 'SPEI_TTS_AUDIO_LEVEL',
    'SITooQuiet', 'DISPID_SRCCmdMaxAlternates', 'DISPID_SRCState',
    'SPRECOCONTEXTSTATUS', 'DISPID_SPERequiredConfidence',
    'SPRS_ACTIVE', 'DISPID_SOTGetDescription', 'SPFM_OPEN_READONLY',
    'ISpeechPhraseProperties', 'SpeechEmulationCompareFlags',
    'SVSFParseSsml', 'SpeechLoadOption', 'DISPID_SpeechMemoryStream',
    'SpeechTokenIdUserLexicon', 'DISPID_SGRsFindRule',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechAudioFormat',
    'SREPrivate', 'SpSharedRecoContext',
    'DISPID_SRGCmdLoadFromMemory', 'SpeechCategoryAudioOut',
    'SAFTADPCM_44kHzStereo', 'ISpObjectTokenCategory',
    'DISPID_SPEPronunciation', 'SPWAVEFORMATTYPE', 'DISPID_SOTsCount',
    'SAFTExtendedAudioFormat', 'SP_VISEME_19', 'SRTEmulated',
    'SASStop', 'DISPID_SRAudioInput', 'SpVoice', 'SpFileStream',
    'ISpeechLexiconWord', 'SP_VISEME_21', 'DISPID_SRRAudio',
    'ISpObjectToken', 'SPSMF_SAPI_PROPERTIES',
    'ISpeechPhraseInfoBuilder', 'SPINTERFERENCE_TOOFAST',
    'SDTAlternates', 'ISpeechRecognizerStatus',
    'DISPID_SPRuleChildren', 'SVF_None', 'eLEXTYPE_PRIVATE5',
    'SPPS_Noun', 'ISpeechMemoryStream', 'SPDKL_LocalMachine',
    'DISPID_SRIsUISupported', 'DISPID_SRGReset', 'STCAll',
    'SPAR_Unknown', 'SpeechUserTraining',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFTCCITT_ALaw_22kHzStereo', 'eLEXTYPE_RESERVED10',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SRESoundEnd',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpGrammarBuilder',
    'SAFT48kHz16BitMono', 'SDKLLocalMachine', 'SPEVENT', 'SPBO_AHEAD',
    'DISPID_SpeechPhraseBuilder', 'SPPS_RESERVED1',
    'SAFTGSM610_11kHzMono', 'SPINTERFERENCE_TOOQUIET', 'SPEVENTENUM',
    'SpNotifyTranslator', 'SpCustomStream', 'SPEI_RESERVED6',
    'DISPID_SLPs_NewEnum', 'SPLOADOPTIONS', 'DISPID_SRGRecoContext',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_RECO_STATE_CHANGE',
    'SpInProcRecoContext', 'ISpPhoneConverter',
    'DISPID_SPEDisplayAttributes', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRCEPhraseStart', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPSSuppressWord', 'DISPID_SLGetWords', 'SPEI_START_SR_STREAM',
    'SPVPRI_ALERT', 'IStream', 'SPEI_MAX_TTS', 'DISPID_SMSADeviceId',
    'SGPronounciation', 'SAFT8kHz16BitMono', 'DISPID_SLPType',
    'SVSFlagsAsync', 'SAFT24kHz16BitStereo',
    'DISPID_SPIEnginePrivateData', 'DISPID_SREmulateRecognition',
    'SGDSInactive', 'DISPID_SRCERequestUI', 'SGDisplay', 'SPWF_INPUT',
    'SAFT44kHz8BitStereo', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SDKGetlongValue', 'SpeechPropertyResponseSpeed',
    'ISpAudio', 'DISPID_SRIsShared', 'DISPID_SGRSTText',
    'DISPID_SRRTimes', 'SECFNoSpecialChars', 'SPAS_CLOSED',
    'SAFT11kHz16BitMono', 'DISPID_SRCESoundEnd',
    'DISPID_SpeechBaseStream', 'SPSHORTCUTPAIR', 'SASPause',
    'SpeechRuleState', 'DISPID_SVDisplayUI', 'ISpShortcut',
    'DISPID_SRCERecognizerStateChange', 'SWTAdded', 'SVP_13',
    'SPTEXTSELECTIONINFO', 'DISPID_SPRDisplayAttributes',
    'SGSExclusive', 'SpeechAudioState', 'SVP_3',
    'DISPID_SRRTOffsetFromStart', 'eLEXTYPE_PRIVATE16',
    'SAFTNoAssignedFormat', 'SVP_17', 'DISPID_SpeechRecognizer',
    'ISpeechGrammarRules', 'DISPID_SRRAudioFormat', 'WAVEFORMATEX',
    'SRTReSent', 'DISPID_SRCSetAdaptationData', 'SITooLoud',
    'SPDKL_CurrentUser', 'eLEXTYPE_PRIVATE15', 'DISPID_SLWWord',
    'IInternetSecurityMgrSite', 'DISPID_SOTCId',
    'SpeechPropertyLowConfidenceThreshold', 'SVEAllEvents',
    'SREHypothesis', 'DISPID_SpeechWaveFormatEx',
    'IInternetSecurityManager', 'DISPID_SLGenerationId',
    'DISPID_SRSSupportedLanguages', 'ISpeechCustomStream',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SOTDisplayUI',
    'ISpeechPhraseReplacement', 'DISPID_SVResume',
    'SPEI_WORD_BOUNDARY', 'ISpObjectWithToken',
    'DISPID_SRCRequestedUIType', 'ISpNotifyTranslator',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SpeechRecoContextEvents', 'DISPIDSPRG',
    'SAFTCCITT_uLaw_8kHzMono', 'SGLexical', 'SDTReplacement',
    'SPSVerb', 'SVPOver', 'SPPROPERTYINFO', 'DISPID_SPILanguageId',
    'STSF_CommonAppData', 'SPEVENTSOURCEINFO',
    'SpeechRegistryUserRoot', 'SAFTText', 'DISPID_SRGDictationUnload',
    'SPPHRASEELEMENT', 'DISPID_SpeechVoice',
    'SpeechVoiceCategoryTTSRate', 'SVEVoiceChange',
    'DISPID_SRCEPropertyStringChange', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRCEFalseRecognition', 'eLEXTYPE_PRIVATE7',
    'DISPID_SPEs_NewEnum', 'DISPID_SGRsAdd', 'SLOStatic',
    'tagSPPROPERTYINFO', 'ISpeechRecoGrammar', 'SPCATEGORYTYPE',
    'SpeechVisemeFeature', 'DISPID_SRGDictationLoad',
    'DISPID_SPCIdToPhone', 'ISpeechWaveFormatEx',
    'eLEXTYPE_VENDORLEXICON', 'SVP_19', 'SREPropertyStringChange',
    'SpMemoryStream', 'SpStream', 'SRAInterpreter', 'SPAUDIOOPTIONS',
    'ISpeechBaseStream', 'SVEEndInputStream', 'SPWORDLIST',
    'SPSERIALIZEDRESULT', 'SAFTADPCM_22kHzMono', 'DISPID_SOTRemove',
    'SVSFNLPSpeakPunc', 'SPPS_Noncontent', 'SPINTERFERENCE_NOISE',
    'DISPID_SPPsItem', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPINTERFERENCE_TOOSLOW', '_RemotableHandle', 'DISPID_SPAsItem',
    'ISpeechPhraseProperty', 'DISPID_SRRecognizer',
    'SAFT12kHz8BitStereo', 'SRSInactive',
    'SpeechVoiceSkipTypeSentence', 'SPXMLRESULTOPTIONS',
    'STCLocalServer', 'DISPID_SCSBaseStream', 'DISPID_SMSSetData',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechPhraseElement',
    'SpShortcut', 'SGSEnabled', 'DISPID_SPIRetainedSizeBytes',
    'SPPS_SuppressWord', 'SECFDefault', 'DISPID_SVEWord',
    'DISPID_SpeechLexiconWord', 'DISPID_SRGetFormat', 'SPLEXICONTYPE',
    'eLEXTYPE_USER', 'SPSModifier', 'SPPARTOFSPEECH',
    'ISpeechVoiceStatus', 'DISPID_SPRuleFirstElement',
    'DISPID_SRSAudioStatus', 'DISPID_SRCVoicePurgeEvent',
    'SVSFPersistXML', 'SPEI_SR_AUDIO_LEVEL', 'SVSFIsXML', 'SVEViseme',
    'SAFT22kHz8BitMono', 'SpeechGrammarTagUnlimitedDictation',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRRSetTextFeedback', 'DISPID_SASCurrentSeekPosition',
    'SDA_Two_Trailing_Spaces', 'DISPID_SGRSTransitions',
    'SRSInactiveWithPurge', 'ISpeechLexiconPronunciations',
    'DISPID_SLGetGenerationChange', 'DISPID_SPIProperties', 'SVP_4',
    'DISPID_SPRuleParent', 'DISPID_SpeechXMLRecoResult',
    'SpeechDictationTopicSpelling', 'SRSEDone',
    'SpTextSelectionInformation', 'SPBO_PAUSE', 'DISPID_SpeechAudio',
    'SASRun', 'SPEI_RECO_OTHER_CONTEXT', 'SpPhoneConverter',
    'eLEXTYPE_PRIVATE20', 'SPSLMA', 'SPEI_PROPERTY_NUM_CHANGE',
    'SGRSTTTextBuffer', 'SGDSActiveUserDelimited',
    'SpeechRecoProfileProperties', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPEAudioSizeTime', 'DISPID_SGRSTsItem',
    'ISpeechXMLRecoResult', 'DISPID_SOTGetStorageFileName',
    'SAFT11kHz16BitStereo', 'SAFTGSM610_22kHzMono', 'ISpPhraseAlt',
    'DISPID_SRCCreateResultFromMemory', 'SGRSTTEpsilon',
    'SPBOOKMARKOPTIONS', 'SECFEmulateResult', 'STCInprocServer',
    'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE8', 'DISPID_SLPPhoneIds',
    'SPAUDIOSTATE', 'SPCS_DISABLED', 'SAFT48kHz8BitMono',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRCESoundStart',
    'SPSNoun', 'STCRemoteServer',
    'SpeechPropertyHighConfidenceThreshold', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPARecoResult', 'SPSEMANTICERRORINFO', 'SPRULESTATE',
    'SpeechEngineConfidence', 'SP_VISEME_5', 'SPRECOSTATE',
    'DISPID_SpeechPhraseElements', 'DISPID_SASFreeBufferSpace',
    'SVP_12', 'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SRGRules',
    'SP_VISEME_4', 'DISPID_SPIGetText', 'DISPID_SPEActualConfidence',
    'DISPID_SpeechGrammarRule', 'DISPID_SpeechPhraseRules',
    'eLEXTYPE_PRIVATE6', 'SpeechRegistryLocalMachineRoot',
    'SAFT16kHz8BitMono', 'SP_VISEME_10', 'DISPID_SWFEChannels',
    'DISPID_SRGId', 'SGLexicalNoSpecialChars', 'SVP_18',
    'DISPID_SPPEngineConfidence', 'SpInprocRecognizer',
    '_ISpeechVoiceEvents', 'SpAudioFormat', 'SREAllEvents',
    'DISPID_SPPChildren', 'DISPID_SBSFormat', 'SPEI_INTERFERENCE',
    'SP_VISEME_15', 'SVF_Stressed', 'DISPID_SVSkip',
    'SPSTREAMFORMATTYPE', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SPPNumberOfElements',
    'DISPID_SpeechDataKey', 'DISPID_SOTCreateInstance', 'SLTUser',
    'DISPID_SRSClsidEngine', 'SLODynamic', 'DISPID_SRCEventInterests',
    'SAFTADPCM_8kHzMono', 'DISPID_SPIAudioSizeTime', 'SpLexicon',
    'SpeechAddRemoveWord', 'SPCT_DICTATION', 'SREAdaptation',
    'DISPID_SVSLastBookmark', 'SPEI_PHRASE_START', 'DISPID_SOTsItem',
    'DISPID_SRGSetTextSelection', 'SpSharedRecognizer',
    'SPEI_SOUND_START', 'DISPID_SpeechVoiceStatus', 'SRAONone',
    'SpeechRecoContextState', 'SPSUnknown', 'ISpeechPhraseAlternate',
    'SVSFUnusedFlags', 'SAFTADPCM_44kHzMono', 'DISPID_SGRAddState',
    'SGRSTTRule', 'DISPID_SPAs_NewEnum', 'SDTRule',
    'SpeechVisemeType', 'SpeechRecoEvents',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SVEventInterests',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPRNumberOfElements',
    'DISPID_SVVolume', 'SVP_16', 'DISPID_SVPriority',
    'DISPID_SPPValue', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRGCommit',
    'DISPID_SLWsItem', 'ISpEventSink', 'SPBINARYGRAMMAR',
    'DISPID_SRCERecognitionForOtherContext', 'SDTAudio',
    'SAFT32kHz16BitStereo', 'SpeechCategoryRecoProfiles',
    'DISPID_SLPsCount', 'DISPID_SMSAMMHandle', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechPhraseRule', 'DISPIDSPTSI_ActiveLength',
    'SAFT11kHz8BitMono', 'DISPID_SAVolume', 'SPEI_RESERVED2',
    'SLTApp', 'SPRS_INACTIVE', 'SPCT_SUB_DICTATION',
    'ISpXMLRecoResult', 'SPFM_NUM_MODES', 'SAFTCCITT_uLaw_44kHzMono',
    'SPEI_SENTENCE_BOUNDARY', 'ISpResourceManager',
    'SAFTGSM610_8kHzMono', 'SVSFParseAutodetect', 'ISpNotifySource',
    'SPVPRIORITY', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE11', 'SPSHT_Unknown', 'SVP_7', 'DISPID_SVPause',
    'SpCompressedLexicon', 'DISPID_SRSNumberOfActiveRules',
    'SpeechRecognizerState', 'SSFMOpenReadWrite',
    'Speech_Max_Pron_Length', 'ISpeechGrammarRuleState',
    'SPBO_TIME_UNITS', 'DISPID_SABufferNotifySize',
    'ISpPhoneticAlphabetSelection', 'SpNullPhoneConverter',
    'SPXRO_SML', 'SPINTERFERENCE_TOOLOUD', 'SVP_9',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SREStreamStart',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SpeechLexicon',
    'SAFT12kHz8BitMono', 'DISPID_SOTDataKey',
    'DISPID_SGRSAddSpecialTransition', 'DISPIDSPTSI_ActiveOffset',
    'SpeechRecognitionType', 'eLEXTYPE_APP', 'DISPIDSPTSI',
    'SPADAPTATIONRELEVANCE', 'DISPID_SDKEnumKeys',
    'DISPID_SRGSetWordSequenceData', 'SpeechCategoryRecognizers',
    'DISPID_SGRsCommitAndSave', 'ISpeechAudioStatus', 'SITooSlow',
    'SRERecognition', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPPFirstElement', 'DISPID_SpeechAudioStatus',
    'DISPID_SABIEventBias', 'SPAUDIOSTATUS', 'SGRSTTWord',
    'DISPID_SpeechVoiceEvent', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPSHT_NotOverriden', 'DISPID_SDKDeleteValue',
    'DISPID_SPIGrammarId', 'ISpeechPhraseRule', 'SpeechWordType',
    'DISPID_SRCCreateGrammar', 'SpeechPartOfSpeech',
    'ISpeechObjectToken', 'ISpRecognizer3', 'SECLowConfidence',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPS_Verb',
    'SASClosed', 'eLEXTYPE_RESERVED6', 'DISPID_SPIStartTime',
    'SPFM_OPEN_READWRITE', 'SVEBookmark', 'DISPID_SRCEEnginePrivate',
    'DISPID_SPEsCount', 'DISPID_SGRSTType', 'DISPID_SWFEBlockAlign',
    'DISPID_SPRs_NewEnum', 'DISPID_SVAudioOutput', 'SDTDisplayText',
    'DISPID_SPIRule', 'DISPID_SRState', 'DISPID_SGRSTNextState',
    'SpeechStreamSeekPositionType', 'DISPID_SpeechAudioBufferInfo',
    'ISpeechAudio', 'ISpeechRecoResultTimes', 'SAFTADPCM_11kHzMono',
    'SWPUnknownWordUnpronounceable', 'DISPID_SGRAttributes',
    'SAFT16kHz8BitStereo', 'SRERequestUI', 'ISpNotifySink',
    'SPEI_SR_BOOKMARK', 'SREInterference', 'SAFT24kHz16BitMono',
    'SPEI_VOICE_CHANGE', 'DISPID_SGRSTRule', 'SpeechBookmarkOptions',
    'SPRST_ACTIVE_ALWAYS', 'Speech_Default_Weight',
    'DISPID_SAFGetWaveFormatEx', 'SpeechTokenShellFolder',
    'DISPID_SVEStreamEnd', 'IEnumString', 'DISPID_SpeechRecoContext',
    'DISPID_SMSALineId', 'DISPID_SRCBookmark', 'SDKLCurrentConfig'
]
